...
func (x *GetOrderRequest) GetCustomerId() int64 {
	if x != nil {
		return x.CustomerId
	}
	return 0
...
const file_orders_proto_rawDesc = "" +
	...
	"\bquantity\x18\x04 \x01(\x03R\bquantity\"p\n" +
	...
	"\tGetOrders\x12\x10.GetOrderRequest\x1a\x11.GetOrderResponse\"\x00B/Z-github.com/kalpesh172000/gsaras/common/ordersb\x06proto3"
